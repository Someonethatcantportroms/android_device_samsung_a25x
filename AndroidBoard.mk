...
$(INSTALLED_DTBOIMAGE_JPN_TARGET): $(PRODUCT_OUT)/kernel $(MKDTBOIMG)
	$(hide) echo "Building dtbo_jpn.img"
	$(hide) $(MKDTBOIMG) cfg_create $@ $(DTBO_CFG) -d $(DTBO_DIR)
	$(hide) $(call assert-max-image-size,$@,$(BOARD_DTBOIMG_JPN_PARTITION_SIZE),raw)

.PHONY: dtboimage
dtboimage: $(INSTALLED_DTBOIMAGE_JPN_TARGET)

INSTALLED_RADIOIMAGE_TARGET += $(INSTALLED_DTBOIMAGE_JPN_TARGET)
